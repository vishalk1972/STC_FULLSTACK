...
const AdminGetGroup = ()=> {
  ...
  return (
    GroupList===null ? <Shimmer type="List Of All Group" className="border-b-2 w-[18%] h-16 flex flex-col  p-4 rounded-2xl shadow-xl bg-gradient-to-r from-slate-400 to-slate-300 gap-1"/>:
    <div className='bg-gray-300 min-h-screen'>
      <div className='flex justify-end gap-5 pt-5 px-5'>
          <Link to="/admin/dashboard/addGroup"><button className='bg-slate-700 text-white  py-1 hover:bg-slate-600 px-4 text-xl rounded-xl focus:outline-none focus:shadow-outline'>Add Another Group</button></Link>
    ...
    <div className='flex flex-col items-center justify-center gap-5 h-max py-14'>
      <h1 className='text-2xl mb-1'>List Of All Group</h1>
      {
        GroupList.map((group)=>{
